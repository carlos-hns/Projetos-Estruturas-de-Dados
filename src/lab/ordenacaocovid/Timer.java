public class Timer {
  ...
  private long[] insertionTime = new long[3];
  private long[] seletionTime = new long[3];
  private long[] mergeTime = new long[3];
  private long[] quickTime = new long[3];
  private long[] quickMedTime = new long[3];
  private long[] countingTime = new long[3];
  private long[] heapTime = new long[3];
